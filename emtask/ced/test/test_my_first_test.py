...
row = {"ENTITY_KEYNAME": "Contact", "NAME": "inlineView"}
...
def testing_with_mock(mocker):
    ...
    mockCreateSQLCmd = mocker.patch(
        "emtask.sql.tasks.CreateSQLTaskCommand", autospec=True
    )
